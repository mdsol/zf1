...
defined('TESTS_ZEND_DB_ADAPTER_MYSQL_USERNAME') || define('TESTS_ZEND_DB_ADAPTER_MYSQL_USERNAME', 'root');
...
defined('TESTS_ZEND_DB_ADAPTER_MYSQL_HOST') || define('TESTS_ZEND_DB_ADAPTER_MYSQL_HOST', 'localhost');
